...
const vi = {
  ...
  form: {
    ...
    desc: "Nhập email Coursera, email liên hệ (nếu có), mật khẩu và Course ID / URL.",
    email: "Email Coursera",
    emailPh: "example@gmail.com",
    contactEmail: "Email cá nhân để liên hệ",
    contactEmailPh: "yourname@gmail.com",
...
const en: Translations = {
  ...
  form: {
    ...
    desc: "Enter your Coursera email, optional contact email, password and Course ID / URL.",
